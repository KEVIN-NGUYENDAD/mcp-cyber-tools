...
Cập nhật: 2026-09-14T07:54:03.562454
...
|---|---|
| Tổng chỉ báo | **577** |
| Còn lại sau lọc tiếng ồn | **369** |
| Bị hạ xuống tiếng ồn | 208 |
| HIGH confidence | 369 |
| MEDIUM confidence | 0 |
| LOW confidence | 0 |
| Quy kết FULL | 367 |
...
| `lateral_movement` | 436 | 208 | 96.3 | H 228 / M 0 / L 0 |
| `suspicious_processes` | 45 | 0 | 98.6 | H 45 / M 0 / L 0 |

## High Confidence (≥ 75) — 369 chỉ báo
...
| 100 | 36 | `suspicious_processes` | Network Connection | INFO | PROCESS_TABLE | COMPLETE | FULL |
...
| 100 | 1 | `suspicious_processes` | Network Connection | INFO | SERVICE | COMPLETE | FULL |
...
| 87 | 3 | `suspicious_processes` | Network Connection | INFO | PROCESS_TABLE | PARTIAL | FULL |
