...
Cập nhật: 2026-09-14T07:38:21.702843
...
|---|---|
| Tổng chỉ báo | **602** |
| Còn lại sau lọc tiếng ồn | **375** |
| Bị hạ xuống tiếng ồn | 227 |
| HIGH confidence | 375 |
| MEDIUM confidence | 0 |
| LOW confidence | 0 |
| Quy kết FULL | 373 |
...
|---|---|---|---|---|
| `credential_dumping` | 0 | 0 | 0.0 | H 0 / M 0 / L 0 |
| `persistence` | 96 | 0 | 100.0 | H 96 / M 0 / L 0 |
| `lateral_movement` | 455 | 227 | 96.3 | H 228 / M 0 / L 0 |
| `suspicious_processes` | 51 | 0 | 98.2 | H 51 / M 0 / L 0 |

## High Confidence (≥ 75) — 375 chỉ báo
...
| 100 | 41 | `suspicious_processes` | Network Connection | INFO | PROCESS_TABLE | COMPLETE | FULL |
