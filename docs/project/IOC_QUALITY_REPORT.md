...
Cập nhật: 2026-09-14T13:31:46.911633
...
|---|---|
| Tổng chỉ báo | **573** |
| Còn lại sau lọc tiếng ồn | **373** |
| Bị hạ xuống tiếng ồn | 200 |
| HIGH confidence | 373 |
| MEDIUM confidence | 0 |
| LOW confidence | 0 |
| Quy kết FULL | 371 |
...
| `lateral_movement` | 426 | 200 | 96.3 | H 226 / M 0 / L 0 |
| `suspicious_processes` | 51 | 0 | 97.7 | H 51 / M 0 / L 0 |

## High Confidence (≥ 75) — 373 chỉ báo
...
| 100 | 39 | `suspicious_processes` | Network Connection | INFO | PROCESS_TABLE | COMPLETE | FULL |
